...
export const ProjectDependencyFindUniqueOrThrowSchema: z.ZodType<Prisma.ProjectDependencyFindUniqueOrThrowArgs> = z.object({ select: ProjectDependencySelectObjectSchema.optional(), include: ProjectDependencyIncludeObjectSchema.optional(), where: ProjectDependencyWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.ProjectDependencyFindUniqueOrThrowArgs>;

export const ProjectDependencyFindUniqueOrThrowZodSchema = z.object({ select: ProjectDependencySelectObjectSchema.optional(), include: ProjectDependencyIncludeObjectSchema.optional(), where: ProjectDependencyWhereUniqueInputObjectSchema }).strict();