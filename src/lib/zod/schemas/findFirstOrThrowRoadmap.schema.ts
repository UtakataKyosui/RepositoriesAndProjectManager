...
export const RoadmapFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RoadmapSelect> = z.object({
...
export const RoadmapFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    description: z.boolean().optional(),
    published: z.boolean().optional(),
...
export const RoadmapFindFirstOrThrowSchema: z.ZodType<Prisma.RoadmapFindFirstOrThrowArgs> = z.object({ select: RoadmapFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RoadmapIncludeObjectSchema.optional()), orderBy: z.union([RoadmapOrderByWithRelationInputObjectSchema, RoadmapOrderByWithRelationInputObjectSchema.array()]).optional(), where: RoadmapWhereInputObjectSchema.optional(), cursor: RoadmapWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RoadmapScalarFieldEnumSchema, RoadmapScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RoadmapFindFirstOrThrowArgs>;

export const RoadmapFindFirstOrThrowZodSchema = z.object({ select: RoadmapFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RoadmapIncludeObjectSchema.optional()), orderBy: z.union([RoadmapOrderByWithRelationInputObjectSchema, RoadmapOrderByWithRelationInputObjectSchema.array()]).optional(), where: RoadmapWhereInputObjectSchema.optional(), cursor: RoadmapWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RoadmapScalarFieldEnumSchema, RoadmapScalarFieldEnumSchema.array()]).optional() }).strict();