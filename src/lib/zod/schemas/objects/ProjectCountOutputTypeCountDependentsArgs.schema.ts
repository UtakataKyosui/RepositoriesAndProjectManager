...
export const ProjectCountOutputTypeCountDependentsArgsObjectSchema = makeSchema();
export const ProjectCountOutputTypeCountDependentsArgsObjectZodSchema = makeSchema();
