...
export const RepositoryFindFirstSelectSchema: z.ZodType<Prisma.RepositorySelect> = z.object({
...
export const RepositoryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    url: z.boolean().optional(),
    name: z.boolean().optional(),
    projectId: z.boolean().optional(),
